...
;;;; +------------+
  (custom-theme-set-faces
    ...
    `(avy-background-face ((,class (:foreground ,nord3))))
    `(avy-lead-face ((,class (:foreground ,nord8 :background ,nord0))))
    `(avy-lead-face-0 ((,class (:foreground ,nord8 :background ,nord0))))
   ...
   `(diff-hl-delete ((,class (:background ,nord11))))
    ...
    `(corfu-current ((,class (:background ,nord3))))
